...
| Tekk | https://tekk.coach/ | 2026-06-18 | public_competitor | Codebase-first AI CTO/spec agent that reads the repo, audits it nightly, and writes scoped specs for coding agents. | High adaptivity for code/spec execution; PMF and customer behavior evidence remain outside the loop. |
| pre.dev | https://pre.dev/ | 2026-06-18 | public_competitor | AI CTO/dev-team agent that plans apps, creates milestones and tasks, then ships code with verification and PR workflows. | Strong autonomous build workflow; evidence target is working software rather than paid asks or customer behavior. |
| VentureOS | https://www.ventureos.com/ | 2026-06-18 | public_competitor | Operating system for URLs/domains that turns premium URLs into autonomous smart ventures with AI agents, playbooks, and tokenized incentives. | Adjacent venture-creation automation; monetization framing overlaps, but not a local solo-developer PMF evidence loop. |
| CoFounder OS | https://www.cofounderos.ai/ | 2026-06-18 | public_competitor | Enterprise AI strategy, implementation, and training platform powered by CoFounder OS. | Broad AI business-infrastructure competitor; less direct than founder PMF tools and no local project-record loop. |
