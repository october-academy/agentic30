...
export function buildExternalOfficeHoursDigestPrompt({
  ...
  return [
    ...
    "Cloudflare: discover tools with ToolSearch query exactly: cloudflare-api cloudflare_api mcp__cloudflare_api execute.",
    "Cloudflare Codex tool rule: use mcp__cloudflare_api.execute. Do not look for a literal cloudflare-api tool; use execute only, not search or graphql_query.",
    "Cloudflare Claude tool rule: use the execute tool exposed as mcp__cloudflare-api__execute or mcp__cloudflare_api__execute. Mutating calls are denied.",
