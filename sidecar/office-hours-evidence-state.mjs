...
// Day 1 get_users ladder cards define the active user, candidate, request,
// evidence format, and commitment. Those are plans or definitions, not real
// transactions, so they never satisfy the hard-evidence detector even when the
// model emits a nextIntent that sounds strong.
