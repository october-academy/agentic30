...
export const FOUNDATION_VALUE_CONTRACTS = Object.freeze({
  ...
  2: contract({
    ...
    evidenceArtifact: "docs/ICP.md, docs/SPEC.md, day-2-evidence-log.md",
    canonicalDocs: [
      doc("docs/ICP.md", "현재 대안/status quo와 이미 돈이 흐르는 adjacent market이 연결됐는지"),
      doc("docs/SPEC.md", "대체재 5개, 가격/리뷰/광고 흔적, 반증 1개가 제품 가설 근거로 반영됐는지"),
    ],
  ...
  3: contract({
    ...
    evidenceArtifact: "docs/ICP.md, docs/GOAL.md, docs/SPEC.md v1, day-3-interview-script.md",
    canonicalDocs: [
      doc("docs/ICP.md", "인터뷰 대상과 validation signals가 실제 ICP 조건에 맞게 좁혀졌는지"),
      doc("docs/GOAL.md", "이번 주 고객 대화/DM lock-in이 KR 또는 weekly milestone으로 들어갔는지"),
      doc("docs/SPEC.md", "약한 가설과 그 가설을 검증/반증할 질문 5개가 SPEC v1 기준에 반영됐는지"),
    ],
  ...
  4: contract({
    ...
    evidenceArtifact: "docs/VALUES.md, docs/SPEC.md, day-4-rewrite-decision.md",
    canonicalDocs: [
      doc("docs/VALUES.md", "Narrow beats wide / 고객이 먼저다 같은 결정 원칙이 오늘 tradeoff에 적용됐는지"),
      doc("docs/SPEC.md", "약한 섹션이 더 좁은 페르소나, 더 빠른 결과, 더 적은 클릭, 더 낮은 가격 중 하나로 재작성됐는지"),
    ],
  ...
  5: contract({
    ...
    evidenceArtifact: "docs/GOAL.md, docs/ICP.md, docs/SPEC.md v2, day-5-demand-signal.md",
    canonicalDocs: [
      doc("docs/GOAL.md", "Product Signals 표에 reply/install/price signal 같은 행동 지표가 들어갔는지"),
      doc("docs/ICP.md", "긍정/경고 신호가 실제 수요 신호와 허수 지표를 구분하도록 갱신됐는지"),
      doc("docs/SPEC.md", "demand signal 판단과 반증이 SPEC v2에 반영됐는지"),
    ],
  ...
  6: contract({
    ...
    evidenceArtifact: "docs/VALUES.md, docs/GOAL.md, docs/SPEC.md, monetization-ask-result.md",
    canonicalDocs: [
      doc("docs/VALUES.md", "고객이 먼저다 / 숫자로 결정하라 / 책임감 원칙이 실제 ask 행동으로 검증됐는지"),
      doc("docs/GOAL.md", "ask 대상, 가격/시간 약속, 응답 기한, 결과가 Dogfood Evidence로 기록됐는지"),
      doc("docs/SPEC.md", "monetization/ask evidence가 MVP success metric 또는 go/no-go 기준에 연결됐는지"),
    ],
  ...
  7: contract({
    ...
    evidenceArtifact: "docs/ICP.md, docs/VALUES.md, docs/GOAL.md, docs/SPEC.md v3, go-no-go.md, foundation-summary.md",
    canonicalDocs: [
      doc("docs/ICP.md", "7일 증거로 ICP/anti-ICP/validation signals가 더 좁아졌는지"),
      doc("docs/VALUES.md", "이번 주 실제 tradeoff가 가치 원칙을 강화했는지, 틀렸다면 어떤 원칙을 고쳐야 하는지"),
      doc("docs/GOAL.md", "weekly check-in, product signals, next week commitments가 evidence 기반으로 갱신됐는지"),
      doc("docs/SPEC.md", "SPEC v3가 계속/재시작/피벗 결정과 다음 proof target을 반영하는지"),
    ],
