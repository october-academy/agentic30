...
**agentic30_request_user_input with pre-filled context:** Pre-fill what you inferred from the codebase,
...
Use agentic30_request_user_input to confirm before spending API credits:
...
After receiving feedback (via HTTP POST or agentic30_request_user_input fallback), output a clear
...
Use agentic30_request_user_input to confirm before saving.
...
If standalone, offer next steps via agentic30_request_user_input:
