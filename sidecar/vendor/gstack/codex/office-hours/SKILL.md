...
5. **Ask: what's your goal with this?** This is a real question, not a formality. The answer determines everything about how the session runs.
   ...
   Via agentic30_request_user_input, ask:
...
Ask these questions **ONE AT A TIME** via agentic30_request_user_input. Push on each one until the answer is specific, evidence-based, and uncomfortable. Comfort means the founder hasn't gone deep enough.
...
Ask these **ONE AT A TIME** via agentic30_request_user_input. The goal is to brainstorm and sharpen the idea, not interrogate.
...
- Ask via agentic30_request_user_input: "Should we build on this prior design or start fresh?"
...
**Privacy gate:** Before searching, use agentic30_request_user_input: "I'd like to search for what the world thinks about this space to inform our discussion. This sends generalized category terms (not your specific idea) to a search provider. OK to proceed?"
...
Use agentic30_request_user_input to confirm. If the user disagrees with a premise, revise understanding and loop back.
...
Use agentic30_request_user_input (regardless of codex availability):
...
6. **Premise revision check:** If Codex challenged an agreed premise, use agentic30_request_user_input:
...
Present via agentic30_request_user_input. Do NOT proceed without user approval of the approach.
...
If `$D serve` is not available or fails, fall back to agentic30_request_user_input:
...
If Codex is available, use agentic30_request_user_input:
...
Present the reviewed design doc to the user via agentic30_request_user_input:
...
Then use agentic30_request_user_input: "Would you consider applying to Y Combinator?"
...
3. Use agentic30_request_user_input to offer opening the resources:
...
- **Questions ONE AT A TIME.** Never batch multiple questions into one agentic30_request_user_input.
